const positions = [
  {
    ...
    points: [
      ...
      'Adopted AI-native engineering workflows: run parallel AI agents across git worktrees for concurrent ticket development, set up MCP integrations with GitHub, databases, and Datadog for real-time system context, and configured reusable AI skills and agents for consistent delivery across repositories.',
    ],
  },
  {
    company: 'Xenia',
