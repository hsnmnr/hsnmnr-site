...
const work: Position[] = [
  {
    ...
    highlights: [
      ...
      'Drove architectural decisions for scalable system growth, defining service boundaries, data models, and API contracts across 5+ backend microservices.',
    ],
  },
  {
    name: 'AIO',
    position: 'Software Engineer',
    // TODO: replace with real company URL if available
    url: 'https://aiotechnologies.com',
  ...
  },
  {
    ...
    // TODO: confirm KalPay URL
    url: 'https://kalpay.com',
  ...
  },
  {
    name: 'Kcube AI',
    position: 'Software Engineer',
    // TODO: confirm Kcube AI URL
    url: 'https://kcubeai.com',
